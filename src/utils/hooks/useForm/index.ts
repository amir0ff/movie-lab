 ...
 *
 * @param {object} formSchema - initial form state with validation model.
 * @param {function} formSubmitCallback - function to run on form submission.
 ...
 **/
export function useForm(formSchema: FormSchemaType, formSubmitCallback: () => void) {
